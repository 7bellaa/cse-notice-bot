...
PROMPT_TEMPLATE = (
    ...
    "- deadline: 학생이 행동(신청·제출·참석·인정 등)을 끝내야 하는 마감일 또는 종료일. "
    "다음 모두 포함: 신청·접수·제출 마감일, 명시된 \"인정 기간\"·\"모집 기간\"·"
    "\"운영 기간\"·\"신청 기간\"·\"참가 기간\"의 종료일. "
    "단순 게시·공지·안내 기간이나 행사 자체 일정(개최일·시작일)은 제외. "
    "YYYY-MM-DD 형식. 없거나 모호하면 null. 여러 개면 가장 빠른 것.\n\n"
    "공지 본문:\n{body}"
)
